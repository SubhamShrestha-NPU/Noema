...
export declare namespace StructuredOutputConfig {
    type StructuralTag = string | Regex | JSONSchema | EBNF | ConstString | AnyText | QwenXMLParametersFormat | Concat | Union | Tag | TriggeredTags | TagsWithSeparator;
...
export declare class StructuredOutputConfig {
    ...
    static QwenXMLParametersFormat(jsonSchema: string): StructuredOutputConfig.QwenXMLParametersFormat;
    static Concat(...elements: StructuredOutputConfig.StructuralTag[]): StructuredOutputConfig.Concat;
...
export type GenerationConfig = GenericGenerationConfig & BeamSearchGenerationConfig & RandomSamplingsGenerationConfig & CDPrunerGenerationConfig & AssistingGenerationConfig & StructuredOutputGenerationConfig & ParserGenerationConfig;
